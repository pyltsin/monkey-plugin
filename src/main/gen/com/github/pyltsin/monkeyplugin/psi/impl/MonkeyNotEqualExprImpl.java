...
public class MonkeyNotEqualExprImpl extends MonkeyExprImpl implements MonkeyNotEqualExpr {

  public MonkeyNotEqualExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PsiElement getNotEq() {
    return notNullChild(findChildByType(NOT_EQ));
  }
