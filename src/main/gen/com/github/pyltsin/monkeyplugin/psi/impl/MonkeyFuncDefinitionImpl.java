...
public class MonkeyFuncDefinitionImpl extends ASTWrapperPsiElement implements MonkeyFuncDefinition {

  public MonkeyFuncDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
